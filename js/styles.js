const bod = document.body,
    title = document.getElementById('cclm-title'),
    ...
    sb = document.getElementById("sideBorder"),
    cir = document.getElementById("circleTab"),
    footer = document.getElementById('FTR'),
    btnFooter = document.getElementById('btnFTR');
